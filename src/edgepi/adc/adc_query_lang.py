...
class ADCProperties(Enum):
    ...
    IDAC1_MAG = Property(
        ...
        BitMask.LOW_NIBBLE.value,
        {
            ...
            IDACMAG.IDAC1_100.value.op_code: PropertyValue(100, IDACMAG.IDAC1_OFF),
            IDACMAG.IDAC1_250.value.op_code: PropertyValue(250, IDACMAG.IDAC1_OFF),
            IDACMAG.IDAC1_500.value.op_code: PropertyValue(500, IDACMAG.IDAC1_OFF),
            IDACMAG.IDAC1_750.value.op_code: PropertyValue(750, IDACMAG.IDAC1_OFF),
            IDACMAG.IDAC1_1000.value.op_code: PropertyValue(1000, IDACMAG.IDAC1_OFF),
            IDACMAG.IDAC1_1500.value.op_code: PropertyValue(1500, IDACMAG.IDAC1_OFF),
            IDACMAG.IDAC1_2000.value.op_code: PropertyValue(2000, IDACMAG.IDAC1_OFF),
            IDACMAG.IDAC1_2500.value.op_code: PropertyValue(2500, IDACMAG.IDAC1_OFF),
            IDACMAG.IDAC1_3000.value.op_code: PropertyValue(3000, IDACMAG.IDAC1_OFF),
        },
    )
    IDAC2_MAG = Property(
        "idac-2-mag",
        ...
        BitMask.HIGH_NIBBLE.value,
        {
            ...
            IDACMAG.IDAC2_100.value.op_code: PropertyValue(100, IDACMAG.IDAC2_OFF),
            IDACMAG.IDAC2_250.value.op_code: PropertyValue(250, IDACMAG.IDAC2_OFF),
            IDACMAG.IDAC2_500.value.op_code: PropertyValue(500, IDACMAG.IDAC2_OFF),
            IDACMAG.IDAC2_750.value.op_code: PropertyValue(750, IDACMAG.IDAC2_OFF),
            IDACMAG.IDAC2_1000.value.op_code: PropertyValue(1000, IDACMAG.IDAC2_OFF),
            IDACMAG.IDAC2_1500.value.op_code: PropertyValue(1500, IDACMAG.IDAC2_OFF),
            IDACMAG.IDAC2_2000.value.op_code: PropertyValue(2000, IDACMAG.IDAC2_OFF),
            IDACMAG.IDAC2_2500.value.op_code: PropertyValue(2500, IDACMAG.IDAC2_OFF),
            IDACMAG.IDAC2_3000.value.op_code: PropertyValue(3000, IDACMAG.IDAC2_OFF),
        },
    )
    REFMUX_POS = Property(
        "ref-mux-positive",
