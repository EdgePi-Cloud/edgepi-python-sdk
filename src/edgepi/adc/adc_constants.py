...
class REFMUX(Enum):
    ...
    NEG_REF_EXT_AIN0 = OpCode(0x1, ADCReg.REG_REFMUX.value, ADCMasks.RMUXN_BITS.value)
    NEG_REF_EXT_AIN1 = OpCode(0x2, ADCReg.REG_REFMUX.value, ADCMasks.RMUXN_BITS.value)
    NEG_REF_EXT_AIN2 = OpCode(0x3, ADCReg.REG_REFMUX.value, ADCMasks.RMUXN_BITS.value)
