...
@pytest.mark.parametrize('name, setoutput, clearoutput, address, result', 
                        [('AO_EN1', GpioAOutputSet.SET_OUTPUT_1.value, GpioAOutputClear.CLEAR_OUTPUT_1.value, GpioExpanderAddress.EXP_ONE.value, ['AO_EN1', OpCode(1, 2, 0xFE), OpCode(0, 2, 0xFE), 32]),
                         ('AO_EN1', GpioAOutputSet.SET_OUTPUT_2.value, GpioBOutputClear.CLEAR_OUTPUT_2.value, GpioExpanderAddress.EXP_ONE.value, ['AO_EN1',OpCode(2, 2, 0xFD), OpCode(0, 3, 0xFD), 32]),
                         ('AO_EN1', GpioBOutputSet.SET_OUTPUT_3.value, GpioAOutputClear.CLEAR_OUTPUT_3.value, GpioExpanderAddress.EXP_ONE.value, ['AO_EN1', OpCode(4, 3, 0xFB), OpCode(0, 2, 0xFB), 32]),
                         ('AO_EN1', GpioBOutputSet.SET_OUTPUT_4.value, GpioBOutputClear.CLEAR_OUTPUT_4.value, GpioExpanderAddress.EXP_TWO.value, ['AO_EN1', OpCode(8, 3, 0xF7), OpCode(0, 3, 0xF7), 33])
                        ])
